                ...
                <div className="flex flex-1 flex-col gap-2">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <button
                      ...
                      className="-m-2 inline-flex h-11 w-11 items-center justify-center text-muted-foreground transition hover:text-destructive active:scale-90"
                  ...
                  <div className="mt-auto flex items-center justify-between">
                    <div className="inline-flex items-center rounded-full border border-border bg-bg-surface">
                      <button
                        ...
                        className="inline-flex h-11 w-11 items-center justify-center text-muted-foreground transition hover:text-foreground active:scale-90"
